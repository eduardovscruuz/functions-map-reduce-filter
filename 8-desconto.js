...
// - A função deve imprimir na tela: Se o cliente recebeu desconto, imprima na tela um agradecimento pela compra, 
// o valor total sem desconto, o valor total com desconto e a porcentagem de desconto que ele recebeu.
// - Se o cliente não recebeu desconto, imprima na tela um agradecimento pela compra, o 
// valor total da sua compra e um cupom de desconto. Esse cupom deve ser um valor 
// aleatório entre 10 e 20% para a próxima compra.


function desconto(nome, primeiraCompra, aVista, total) {
...
console.log(`Cliente ${nome} receberá um desconto de ${desconto}% na sua compra!`)
}

desconto('Eduardo', true, true, 1200)
